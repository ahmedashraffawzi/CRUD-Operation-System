...
namespace P.PresentationLayer.ViewModels
{
    public class EmployeeViewModel
    {
        ...
        [MinLength(5, ErrorMessage = "Min Lenght is 5 Char")]
        public string Name { get; set; }
        [Range(22, 35, ErrorMessage = "Age Must be In Range From 22 To 35")]
        public int? Age { get; set; }
        [RegularExpression("^[0-9]{1,3}-[a-zA-Z]{5,10}-[a-zA-Z]{4,10}-[a-zA-Z]{5,10}$", ErrorMessage = "Address Must Be Link 123-Street-City-Country")]
